...
<html>
    ...
    <body  onload="ajaxRequestToGetMyCourse();">
			 ...
			 <select id="myclass" name="myclass" onchange="ajaxRequestToGetMyCourse();">
			   <?php  
             ...
             Select Course
				...
				<select id="mycourse" onchange="ajaxRequestToGetCourseStudent();" name="mycourse">

				</select> <br />
				<br/>

             Select Student
				<select id="mystudent" onchange="" name="mystudent">
